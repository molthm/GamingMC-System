...
client.on('ready', function(){
    var ms = 60000 ;
    var setGame = ['MC!help','Type ahelp'];
    var i = -1;
    var j = 0;
...
${prefix}MC!invites/ íÚÑÖ áß  ÚÏÏ ÇäİÇíÊÇÊß ÈÇáÓíÑİÑ 
${prefix}MC!info <invitelink here> / áãÚáæãÇÊ Úä ÇáÏÚæå
 ãËÇá : invinfo m82n8P
...
${prefix}MC!bc / ÑÓÇáÉ ÌãÇÚíÉ Çáì ßá ÇÚÖÇÁ ÇáÓíÑİÑ
${prefix}MC!bk / ÑÓÇáÉ ÌãÇÚíå ãÚ
...
${prefix}MC!clear <numbr> / ãÓÍ ÇáÔÇÊ ÈÚÏÏ
${prefix}MC!clear / ãÓÍ ÇáÔÇÊ
${prefix}MC!mute @user <time> / ÇÚØÇÁ ÇáÚÖæ ãíæÊ 
${prefix}MC!unmute @user / áİß ÇáãíæÊ Úä ÇáÔÎÕ 
${prefix}MC!kick @user <reason> / ØÑÏ ÇáÔÎÕ ãä ÇáÓíÑİÑ
${prefix}MC!ban @user <reason> / ÍÖÑ ÇáÔÎÕ ãä ÇáÓíÑİÑ
...
**
   `,`
        ***__Music orders__***
**
${prefix}MC!play / áÊÔÛíá ÃÛäíÉ ÈÑÂÈØ Ãæ ÈÃÓã
${prefix}MC!skip / áÊÌÂæÒ ÇáÃÛäíÉ ÇáÍÂáíÉ
${prefix}MC!pause / ÅíŞÂİ ÇáÃÛäíÉ ãÄŞÊÇ
${prefix}MC!resume / áãæÂÕáÉ ÇáÅÛäíÉ ÈÚÏ ÅíŞÂİåÂ ãÄŞÊÇ
${prefix}MC!vol / áÊÛííÑ ÏÑÌÉ ÇáÕæÊ 100 - 0
${prefix}MC!stop / áÅÎÑÂÌ ÇáÈæÊ ãä ÇáÑæã
${prefix}np / áãÚÑİÉ ÇáÃÛäíÉ ÇáãÔÛáÉ ÍÂáíÇ
${prefix}queue / áãÚÑİÉ ŞÂÆãÉ ÇáÊÔÛíá
**
        ***__Games orders__***
 **       
${prefix}MC!hwm / ÍÌÑ æÑŞÉ ãŞÕ
...
${prefix}áæ ÎíÑæß ÈØÑíŞÉ ÍáæÉ / MC!lk
...
if (message.author.id !== '434845976050794516') return message.reply('** åĞÇ ÇáÃãÑ İŞØ áÕÇÍÈ ÇáÈæÊ æ ÔßÑÇğğ **')
client.user.setGame(argresult, "MC!help");
